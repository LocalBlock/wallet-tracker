/**
 * ABI for StakedTokenDataProvider contract
 * @see https://etherscan.io/address/0xb12e82df057bf16ecfa89d7d089dc7e5c1dc057b#code
 */
export const abi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "aaveUsdPriceFeed", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "stakedAsset", type: "address" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bool", name: "inPostSlashingPeriod", type: "bool" },
  ...
  {
    inputs: [
      { internalType: "address[]", name: "stakedAssets", type: "address[]" },
    ...
    outputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: "uint256", name: "rewardsToClaim", type: "uint256" },
          {
            internalType: "uint40",
